 ...
 */
export function shouldCache(config, context) {
 ...
 */
function buildCacheControlHeader(route) {
 ...
 */
function buildCdnCacheControlHeader(route) {
    const directives = ['public'];
 ...
 */
export function getCacheHeaders(config, url) {
    // Find matching route
 ...
 */
export function evaluateCache(config, context) {
